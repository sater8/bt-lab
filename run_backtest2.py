...
def run_backtest(
    ...
    # === MIDDLEWARE GLOBAL ===
    # Desactivado TOTALMENTE para boll_breakout_full_cap
    if strategy_name in ["boll_breakout_full_cap", "dca_monthly"]:
        print("⚠️ Middleware DESACTIVADO completamente para esta estrategia.")
    else:
...
def main():
    ...
    if strategy_name in ["boll_breakout", "boll_breakout_full", "boll_breakout_full_cap"]:
        pass_params = {
            "max_alloc_pct": 0.85,
            "onramp_max": 5,
